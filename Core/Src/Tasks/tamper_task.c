/**
 * @file    tamper_task.c
 * @brief   Tamper detection task - monitors accelerometer and gyroscope
 *          from MPU6050 to detect device movement and physical tampering.
 */
...
/**
 * @brief Tamper detection task - polls MPU6050 and triggers on movement.
 *
 * Monitors accelerometer and gyroscope values from MPU6050 sensor.
 * If any axis exceeds its threshold, sends a tamper event to AuthTask.
 * Runs every 200 ms after AuthTask finishes initialization.
 *
