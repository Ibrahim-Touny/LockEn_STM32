...
#define TIMEOUT                   1000
/* MPU6050 7-bit I2C address is 0x68 when AD0=0, or 0x69 when AD0=1.
 * HAL APIs expect the 8-bit address (7-bit << 1). */
#ifndef MPU6050_ADDR_7BIT
#define MPU6050_ADDR_7BIT         0x68
#endif
#define MPU6050_DEVICE_ADDRESS    (MPU6050_ADDR_7BIT << 1)
